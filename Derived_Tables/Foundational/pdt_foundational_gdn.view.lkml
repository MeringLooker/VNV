view: pdt_foundational_gdn {
    derived_table: {
      explore_source: vnv_gdn {
        ...
        column: quarter { field: vnv_gdn_view.day_quarter }
        column: total_impressions { field: vnv_gdn_view.total_impressions }
        column: total_clicks { field: vnv_gdn_view.total_clicks }
