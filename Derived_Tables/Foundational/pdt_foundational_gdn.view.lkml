view: pdt_foundational_gdn {
    derived_table: {
      explore_source: vnv_gdn {
        ...
        column: total_concierge_form_submission {field: vnv_gdn_ga_view.total_concierge_form_submission}
        column: total_enewsletter_sign_up {field: vnv_gdn_ga_view.total_enewsletter_sign_up}
        column: total_partner_referral {field: vnv_gdn_ga_view.total_partner_referral}
        column: total_view_guide_online {field: vnv_gdn_ga_view.total_view_guide_online}
        column: total_guide_hard_copy_sign_up {field: vnv_gdn_ga_view.total_guide_hard_copy_sign_up}
        column: total_tos_above_45s {field: vnv_gdn_ga_view.total_tos_above_45s}
        filters: {
